...
사람인에서 「수간호사」(부산 전체 + 경남 전체) 검색 결과를 하루 두 번(06:00, 14:00 KST) 자동으로 모아
...
`scripts/fetch_jobs.py` 상단의 `SEARCH_URL`에서 `searchword`(검색어, URL 인코딩)와 `loc_mcd`(지역 코드: 부산 106000, 경남 110000, 울산 107000)를 바꾸면 됩니다.
